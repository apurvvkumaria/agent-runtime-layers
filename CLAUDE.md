...
visible. It was built up in twenty-seven deliberate layers (see below), each adding one runtime
capability.
...
uv run python agent.py marketplace-install error_budget  # verify SHA256, install, load a skill
